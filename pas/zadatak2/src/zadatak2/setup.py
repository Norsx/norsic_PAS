#!/usr/bin/env python3
"""
setup.py za zadatak2 ROS 2 Python paket
"""
...
package_name = 'zadatak2'

# Pronađi sve packages u current direktoriju
packages = find_packages(where='.', include=['zadatak2*'])
...
setup(
    ...
    zip_safe=True,
    maintainer='Norsx',
    maintainer_email='ivan.norsic01@gmail.com',
    description='ROS2 Python package for autonomous system mapping and path planning using D* algorithm',
    license='Apache-2.0',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'd_star_path_planner = zadatak2.d_star_path_planner:main',
            'map_republisher = zadatak2.map_republisher:main',
            'path_planning_node = zadatak2.path_planning_node:main',
            'goal_navigation_node = zadatak2.goal_navigation_node:main',
            'path_follower = zadatak2.path_follower_node:main',
            'nav2_adapter = zadatak2.nav2_adapter:main',
        ],
    },
)
