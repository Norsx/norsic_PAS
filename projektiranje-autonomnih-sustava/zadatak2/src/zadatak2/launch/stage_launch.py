...
# -*- coding: utf-8 -*-
"""
Stage Simulator Launch File - Adapted for zadatak2
Koristi world datoteke iz zadatak2/world direktorija

Usage:
    ros2 launch zadatak2 stage_launch.py
    ros2 launch zadatak2 stage_launch.py world:=map_01
"""
...
def generate_launch_description():
    # Koristi zadatak2 paket
    student_share = get_package_share_directory('zadatak2')
